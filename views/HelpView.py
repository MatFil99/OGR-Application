...
class HelpView(Toplevel):
    ...
    def create_label(self, text, col, row, colspan, rowspan, st, padx, pady, wraptext=0):
        ...
        # self.in_path.grid(column=0, row=1, columnspan=1, rowspan=1, sticky=(NW))
        # self.in_path_desc.grid(column=1, row=1, columnspan=1, rowspan=1, sticky=(W))
        # self.out_path.grid(column=0, row=2, columnspan=1, rowspan=1, sticky=(NW))
        # self.out_path_desc.grid(column=1, row=2, columnspan=1, rowspan=1, sticky=(W))
        # self.bg_brightness.grid(column=0, row=3, columnspan=1, rowspan=1, sticky=(NW))
        # self.bg_brightness_desc.grid(column=1, row=3, columnspan=1, rowspan=1, sticky=(W))
        # self.graph_type.grid(column=0, row=4, columnspan=1, rowspan=1, sticky=(NW))
        # self.graph_type_desc.grid(column=1, row=4, columnspan=1, rowspan=1, sticky=(W))
        # self.in_img_type.grid(column=0, row=5, columnspan=1, rowspan=1, sticky=(NW))
        # self.in_img_type_desc.grid(column=1, row=5, columnspan=1, rowspan=1, sticky=(W))
        # self.vert_filled.grid(column=0, row=6, columnspan=1, rowspan=1, sticky=(NW))
        # self.vert_filled_desc.grid(column=1, row=6, columnspan=1, rowspan=1, sticky=(W))
